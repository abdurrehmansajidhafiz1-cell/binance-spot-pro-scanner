...
[![Win Rate](https://img.shields.io/badge/Win_Rate-42.9%25-blue?style=for-the-badge)](LIVE_RESULTS.md)
[![Profit Factor](https://img.shields.io/badge/Profit_Factor-0.56-orange?style=for-the-badge)](LIVE_RESULTS.md)
[![Total Qualified Trades](https://img.shields.io/badge/Total_Qualified-8-informational?style=for-the-badge)](LIVE_RESULTS.md)

> **Last Updated:** `2026-09-07 20:31:27 PKT (15:31:27 UTC)`  
...
| **Current Equity** | `$496.61 USDT` | **Completed Trades** | `7 Trades` |
| **Available Cash** | `$397.43 USDT` | **Active / In-Trade** | `1 Trade` |
| **Net PnL ($)** | `-$3.39 USDT` | **Win / Loss Ratio** | `3 Win / 4 Loss` |
| **Net Return (%)** | `-0.68%` | **Win Rate** | `42.86%` |
| **Peak Equity** | `$500.00 USDT` | **Profit Factor** | `0.56` |
| **Max Drawdown** | `-0.68%` | **Total Fees Deducted** | `$1.12 USDT` |
...
|----------|-----------------------|-------------------------|----------------------------------------|----------------------------------------|------------------------------------------------------------------|-----------------|-------------|------------------------------------------------------------------|----------------------------------------|------------------|----------|
| APTUSDT  | S3_VOLATILITY_SQUEEZE | <b>15m</b>              | 2026-09-07 17:45:00 PKT (12:45:00 UTC) | 2026-09-07 18:01:16 PKT (13:01:16 UTC) | $0.6423<br><small>2026-09-07 18:01:16 PKT (13:01:16 UTC)</small> | $0.6370         | $0.6283     | $0.6497 (TP1)<br><small style='color:#64748b;'>⚪ Pending</small> | $0.6497 (Pending)<br>$0.6548 (Pending) | -0.83 (-0.83%)   | 🟡 ACTIVE |
