...
[![Portfolio Return](https://img.shields.io/badge/Net_Return--3.86%25-red?style=for-the-badge)](LIVE_RESULTS.md)
...
| **Current Equity** | `$480.71 USDT` | **Completed Trades** | `21 Trades` |
| **Available Cash** | `$381.05 USDT` | **Active / In-Trade** | `1 Trade` |
| **Net PnL ($)** | `-$19.29 USDT` | **Win / Loss Ratio** | `5 Win / 16 Loss` |
| **Net Return (%)** | `-3.86%` | **Win Rate** | `23.81%` |
| **Peak Equity** | `$500.00 USDT` | **Profit Factor** | `0.21` |
| **Max Drawdown** | `-3.86%` | **Total Fees Deducted** | `$3.21 USDT` |
