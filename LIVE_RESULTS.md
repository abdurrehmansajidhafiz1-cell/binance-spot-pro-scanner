...
[![Portfolio Return](https://img.shields.io/badge/Net_Return--1.78%25-red?style=for-the-badge)](LIVE_RESULTS.md)
...
> **Last Updated:** `2026-09-08 06:15:46 PKT (01:15:46 UTC)`  
...
| **Current Equity** | `$491.08 USDT` | **Completed Trades** | `10 Trades` |
| **Available Cash** | `$92.59 USDT` | **Active / In-Trade** | `4 Trade` |
| **Net PnL ($)** | `-$8.92 USDT` | **Win / Loss Ratio** | `4 Win / 6 Loss` |
| **Net Return (%)** | `-1.78%` | **Win Rate** | `40.00%` |
| **Peak Equity** | `$500.00 USDT` | **Profit Factor** | `0.33` |
| **Max Drawdown** | `-1.78%` | **Total Fees Deducted** | `$1.79 USDT` |
...
| OPUSDT   | S3_VOLATILITY_SQUEEZE | <b>15m</b>              | 2026-09-08 05:45:00 PKT (00:45:00 UTC) | 2026-09-08 06:01:21 PKT (01:01:21 UTC) | $0.1120<br><small>2026-09-08 06:01:21 PKT (01:01:21 UTC)</small> | $0.1112         | $0.1098     | $0.1132 (TP1)<br><small style='color:#64748b;'>⚪ Pending</small> | $0.1132 (Pending)<br>$0.1141 (Pending) | -0.68 (-0.68%)   | 🟡 ACTIVE |
