...
> **Last Updated:** `2026-09-07 23:46:24 PKT (18:46:24 UTC)`  
...
| **Current Equity** | `$495.13 USDT` | **Completed Trades** | `8 Trades` |
| **Available Cash** | `$495.13 USDT` | **Active / In-Trade** | `0 Trade` |
| **Net PnL ($)** | `-$4.87 USDT` | **Win / Loss Ratio** | `3 Win / 5 Loss` |
| **Net Return (%)** | `-0.97%` | **Win Rate** | `37.50%` |
| **Peak Equity** | `$500.00 USDT` | **Profit Factor** | `0.37` |
| **Max Drawdown** | `-0.97%` | **Total Fees Deducted** | `$1.19 USDT` |
