...
[![Portfolio Return](https://img.shields.io/badge/Net_Return--3.82%25-red?style=for-the-badge)](LIVE_RESULTS.md)
...
> **Last Updated:** `2026-09-09 08:01:23 PKT (03:01:23 UTC)`  
...
| **Current Equity** | `$480.90 USDT` | **Completed Trades** | `21 Trades` |
| **Available Cash** | `$381.05 USDT` | **Active / In-Trade** | `1 Trade` |
| **Net PnL ($)** | `-$19.10 USDT` | **Win / Loss Ratio** | `5 Win / 16 Loss` |
| **Net Return (%)** | `-3.82%` | **Win Rate** | `23.81%` |
| **Peak Equity** | `$500.00 USDT` | **Profit Factor** | `0.21` |
| **Max Drawdown** | `-3.82%` | **Total Fees Deducted** | `$3.21 USDT` |
...
|----------|-----------------------|-------------------------|----------------------------------------|----------------------------------------|--------------------------------------------------------------------|-----------------|-------------|-----------------------------------------------------------------------|--------------------------------------------|------------------|----------|
| ETHUSDT  | S3_VOLATILITY_SQUEEZE | <b>15m</b>              | 2026-09-09 05:45:00 PKT (00:45:00 UTC) | 2026-09-09 06:01:12 PKT (01:01:12 UTC) | $2,496.98<br><small>2026-09-09 06:01:12 PKT (01:01:12 UTC)</small> | $2,493.21       | $2,485.31   | $2,515.71 (+0.75%)<br><small style='color:#64748b;'>⚪ Pending</small> | $2,526.24 (Pending)<br>$2,546.21 (Pending) | -0.15 (-0.15%)   | 🟡 ACTIVE |
